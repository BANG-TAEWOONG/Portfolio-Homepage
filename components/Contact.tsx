...
const Contact: React.FC = () => {
    return (
        <section className="py-20 sm:py-28 md:py-32 px-4 text-center bg-[#F7F7F7]" id="contact">
            <h2 className="text-3xl sm:text-4xl md:text-6xl font-extrabold mb-6 sm:mb-8 tracking-tighter text-[#2a2a2a]">Contact</h2>
            <p className="text-base sm:text-lg font-medium text-[#7a7a7a] mb-10 sm:mb-12 tracking-tight max-w-md mx-auto">
